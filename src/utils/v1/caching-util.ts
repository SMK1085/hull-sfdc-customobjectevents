...
export class CachingUtil {
  ...
  public async getCachedApiResponse<TPayload, TResult, TError>(
    cacheKey: string,
    fn: () => Promise<connector_v1.Schema$ApiResult<TPayload, TResult, TError>>,
    expiresSecs?: number,
    correlationKey?: string,
  ): Promise<connector_v1.Schema$ApiResult<TPayload, TResult, TError>> {
    this.logger.debug(
    ...
    let result:
      | connector_v1.Schema$ApiResult<TPayload, TResult, TError>
      | undefined;
