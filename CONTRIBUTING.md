...
You can [open a ticket](https://github.com/hull/hull-sfdc-customobjectevents/issues/new) with your questions or issues any time. Feature requests are also welcome, please describe the feature, why you need it, and how it should work.
...
- You are using the [latest version](https://github.com/hull/hull-sfdc-customobjectevents/releases).
- You have read the [technical documentation](https://github.com/hull/hull-sfdc-customobjectevents/blob/master/README.md) and the [user documentation](https://github.com/hull/hull-sfdc-customobjectevents/blob/master/assets/readme.md) first, and
